...
<article id="post-<?php the_ID(); ?>" <?php post_class($classes); ?> itemscope="itemscope" itemtype="http://schema.org/Article">
	...
	<div class="content-wrapper" role="main">
		...
		<div class="entry-content" itemprop="articleBody">
			<?php the_content( apply_filters( 'pt_more', __('Continue Reading...', 'handystore')) ); ?>

			<?php wp_link_pages( array(
				'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'handystore' ) . '</span>',
				'after'       => '</div>',
				'link_before' => '<span>',
				'link_after'  => '</span>',
				'pagelink'    => '%',
