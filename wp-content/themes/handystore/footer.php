				...
				<div class="container">
					<div class="row">
						<div class="site-info col-xs-12 col-sm-12 col-md-12">
							...
							<?php } else {
								echo '&copy;&nbsp;<span itemprop="copyrightYear">' . date("Y") . '</span>&nbsp;<span itemprop="copyrightHolder"> Handy Store by <a href="http://themes.zone/" itemprop="url">Themes Zone</a></span>';
							}
							?>
						</div>
					</div>
