	  ...
	  $the_query = new wp_query( $args );
	    ...
	    if ( $the_query->have_posts() ) : ?>
	    		<aside id="related_posts"<?php if (handy_get_option('lazyload_on_post')=='on') : ?> class="lazyload" data-expand="-100"<?php endif; ?>>
	    			<h2 class="related-posts-title" itemprop="name"><?php _e('Related Posts', 'handystore'); ?></h2>
					...
					<li class="post<?php echo esc_attr($class); ?>" itemscope="itemscope" itemtype="http://schema.org/Article">
						...
						<?php if ( has_post_thumbnail() ) { ?>
							<div class='thumb-wrapper'>
								<a class="posts-img-link" rel="bookmark" href="<?php echo esc_url( get_permalink(get_the_ID()) ); ?>" title="<?php _e( 'Click to learn more', 'handystore'); ?>" itemprop="url">
						...
						<div class="item-content">
							...
							<a class="post-link" rel="bookmark" href="<?php echo esc_url( get_permalink(get_the_ID()) ); ?>" title="<?php _e( 'Click to learn more', 'handystore'); ?>" itemprop="url">
							...
							<div class="buttons-wrapper">
								...
								<div class="link-to-post">
									<a rel="bookmark" href="<?php echo esc_url( get_permalink(get_the_ID()) ); ?>" title="<?php _e( 'Click to learn more', 'handystore'); ?>" itemprop="url">
