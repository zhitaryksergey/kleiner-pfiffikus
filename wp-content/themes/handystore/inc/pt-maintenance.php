...
<head>
	...
	<body>
		...
		<div class="msg-wrapper">
			<h3><?php _e('We are working hard to finish our amazing new website!', 'handystore'); ?></h3>
			<img src="<?php echo apply_filters( 'handy_default_maintenance_img', get_template_directory_uri().'/images/maintenance.jpg' ); ?>" title="<?php _e( "Site is under Construction", 'handystore' ); ?>" alt="maintenance"/>
			...
			<?php endif; ?>
			<p><?php echo sprintf( __('If you want to ask us a question - please, <a href="mailto:%1$s">send an e-mail</a> and we will answer ASAP', 'handystore'), sanitize_email(get_bloginfo('admin_email')) ); ?></p>
		</div>
