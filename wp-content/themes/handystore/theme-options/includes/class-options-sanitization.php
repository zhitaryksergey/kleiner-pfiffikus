...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'handystore' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'handystore' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'handystore' ),
		'repeat'    => esc_html__( 'Repeat All', 'handystore' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'handystore' ),
		'top center'    => esc_html__( 'Top Center', 'handystore' ),
		'top right'     => esc_html__( 'Top Right', 'handystore' ),
		'center left'   => esc_html__( 'Middle Left', 'handystore' ),
		'center center' => esc_html__( 'Middle Center', 'handystore' ),
		'center right'  => esc_html__( 'Middle Right', 'handystore' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'handystore' ),
		'bottom center' => esc_html__( 'Bottom Center', 'handystore' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'handystore')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'handystore' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'handystore')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'handystore' ),
		'italic'      => esc_html__( 'Italic', 'handystore' ),
		'bold'        => esc_html__( 'Bold', 'handystore' ),
		'lighter'     => esc_html__( 'Light', 'handystore' ),
		'bold italic' => esc_html__( 'Bold Italic', 'handystore' )
		);
