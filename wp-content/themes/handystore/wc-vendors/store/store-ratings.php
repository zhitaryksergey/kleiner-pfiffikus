...
get_header( 'shop' ); ?>
	...
	<h1 class="page-title"><?php _e( 'Customer Ratings', 'handystore' ); ?></h1>
	...
	<?php if ( $vendor_feedback ) {
		...
		foreach ( $vendor_feedback as $vf ) {
			...
			<div class="single-rating">
				<p>
					<?php _e('Product: ', 'handystore'); ?>
					<a href="<?php echo $product_link; ?>" target="_blank"><?php echo $product_title; ?></a>
				</p>
				<p>
					<span><?php _e( 'Posted on ', 'handystore'); echo $post_date; ?></span>
					<?php _e( ' by ', 'handystore'); echo $customer_name; ?>
				</p>
		...
		<?php }
	} else {  echo __( 'No ratings have been submitted for this vendor yet.', 'handystore' ); }  ?>

	<a class="button" href="<?php echo $vendor_shop_url; ?>"><?php _e( 'Return to store', 'handystore' ); ?></a>
