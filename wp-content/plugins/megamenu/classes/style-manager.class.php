...
#{$wrap} { 
    ...
    public function sf_custom_theme_styles_path()
    {
        return wp_get_upload_dir()['basedir'] . '/sf-custom-theme-styles-' . parse_url(site_url())['host'] . '.css';
    }

    public function sf_custom_theme_styles_url()
    {
        return wp_get_upload_dir()['baseurl'] . '/sf-custom-theme-styles-' . parse_url(site_url())['host'] . '.css';
    }
    ...
    public function head_css() {
        if (!file_exists($this->sf_custom_theme_styles_path())) {
            ...
            file_put_contents($this->sf_custom_theme_styles_path(), $css);
        }

        wp_enqueue_style('sf-custom-theme-styles', $this->sf_custom_theme_styles_url(), [], filemtime($this->sf_custom_theme_styles_path()));
    }
