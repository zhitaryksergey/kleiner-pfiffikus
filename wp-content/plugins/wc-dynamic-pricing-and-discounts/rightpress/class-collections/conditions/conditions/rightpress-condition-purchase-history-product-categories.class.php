...
// Load dependencies
if (!class_exists('RightPress_Condition_Purchase_History')) {
 ...
 * @author RightPress
 */
if (!class_exists('RightPress_Condition_Purchase_History_Product_Categories')) {
...
abstract class RightPress_Condition_Purchase_History_Product_Categories extends RightPress_Condition_Purchase_History
{
    ...
    public function get_label()
    {
        ...
        return __('Purchased - Categories', 'rightpress');
    }
