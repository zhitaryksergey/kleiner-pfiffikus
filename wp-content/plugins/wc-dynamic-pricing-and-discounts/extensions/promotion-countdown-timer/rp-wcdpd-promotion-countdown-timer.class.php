...
class RP_WCDPD_Promotion_Countdown_Timer
{
    ...
    public static function get_countdown_timer_data($product, $quantity = 1, $variation_attributes = array())
    {
        ...
        // Get label
        $label = apply_filters('rp_wcdpd_promotion_countdown_timer_label', esc_html(RP_WCDPD_Settings::get('promo_countdown_timer_label')), $product, $seconds_remaining, $quantity);
