...
function handy_recent_post(){
  ...
  vc_map( array(
      "name" => esc_html__( 'Recent Posts', 'handy-feature-pack' ),
      "base" => "handy_recent_post",
			'category' => esc_html__( 'Handy Shortcodes', 'handy-feature-pack'),
  	  "description" => esc_html__( 'Output Carousel with Recent Posts', 'handy-feature-pack' ),
      ...
      "params" => array(
    			...
    			array(
    				'type' => 'dropdown',
    				'heading' => esc_html__( 'Posts per row', 'handy-feature-pack' ),
    				'param_name' => 'per_row',
    				'value' => array(
    						'3 Posts' => '3',
    						'4 Posts' => '4',
    			...
    			array(
    				'type' => 'position',
    				'heading' => esc_html__( 'Total number of Posts to show', 'handy-feature-pack' ),
                ...
                esc_html__( 'Author', 'handy-feature-pack' ) => 'author',
                esc_html__( 'Comments Quantity', 'handy-feature-pack' ) => 'comment_count',
    					),
    				'std'=> 'date',
    			),
    			array(
    			...
    			array(
    				'type' => 'textfield',
    				'heading' => esc_html__( 'Posts by Category slug', 'handy-feature-pack' ),
    ...
    while( $the_query->have_posts() ) : $the_query->the_post();
      $output .= "<li class='post'>";
          ...
          if ( has_post_thumbnail() ) {
            ...
            $output .= '<a class="posts-img-link" rel="bookmark" href="'.esc_url(get_permalink(get_the_ID())).'" title="'.__( 'Click to learn more', 'handy-feature-pack').'">';
          ...
          $output .= '<div class="meta-data"><span class="author">'.__('By ', 'handy-feature-pack').'<a href="'.esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ).'" rel="author">'.get_the_author().'</a></span>';
          ...
          $output .= '<div class="link-to-post"><a rel="bookmark" href="'.esc_url(get_permalink(get_the_ID())).'" title="'.__( 'Click to learn more', 'handy-feature-pack').'"><i class="fa fa-chevron-right"></i></a></div>';
          $output .= '</div>';
          $output .= '</div>';
