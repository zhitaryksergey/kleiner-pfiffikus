...
class pt_most_viewed_post_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__('Handy Most Viewed Posts', 'handy-feature-pack'), // Name
			array('description' => __( "Handy special widget. Displaying number of most viewed posts on your site.", 'handy-feature-pack' ), )
		);
	}
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('post-quantity'); ?>"><?php _e( 'How many posts to display: ', 'handy-feature-pack' ) ?></label>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id("sort-order"); ?>"><?php _e( 'Reverse sort order (ascending)?', 'handy-feature-pack' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo $this->get_field_id("date"); ?>"><?php _e( 'Show publish date?', 'handy-feature-pack' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo $this->get_field_id("comments"); ?>"><?php _e( 'Show number of comments?', 'handy-feature-pack' ); ?></label>
        </p>
		<p>
			<label for="<?php echo $this->get_field_id('category'); ?>"><?php _e( 'Specify ID of category (categories) to show: ', 'handy-feature-pack' ) ?></label>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id("thumb"); ?>"><?php _e( 'Show post thumbnail?', 'handy-feature-pack' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo $this->get_field_id("excerpt"); ?>"><?php _e( 'Show post excerpt?', 'handy-feature-pack' ); ?></label>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id("excerpt-length"); ?>"><?php _e( 'Excerpt length (in words):', 'handy-feature-pack' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id("excerpt-more"); ?>"><?php _e( 'Excerpt read more text:', 'handy-feature-pack' ); ?></label>
			...
			<li class="most-viewed-item">
				...
				<div class="content-wrapper">
					...
					<div class="most-viewed-entry-meta">
						...
						<div class="views-qty"><i class="fa fa-eye"></i><?php _e('Views: ', 'handy-feature-pack');?><strong><?php echo get_post_meta ($post->ID,'views',true); ?></strong></div>
