...
class pt_contacts_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__('Handy Contacts', 'handy-feature-pack'), // Name
			array( 'description' => __( 'Handy special widget. Configurable Address Widget', 'handy-feature-pack' ), )
		);
  ...
  public function upload_scripts() {
    ...
    wp_enqueue_script( 'pt-upload-media-js', HANDY_FEATURE_PACK_URL . '/admin/js/upload-media.js', array('jquery'), true);
  }
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'company_name' ); ?>"><?php _e( 'Company Name:', 'handy-feature-pack' ); ?></label>
		...
		<p>
            <label for="<?php echo $this->get_field_name( 'image' ); ?>"><?php _e( 'Company Logo:', 'handy-feature-pack' ); ?></label>
            ...
            <span class="button button-primary pt_upload_image_button" id="<?php echo $this->get_field_id( 'image' ).'_button'; ?>" style="margin:10px 0 0 0;"><?php _e('Upload Image', 'handy-feature-pack'); ?></span>
        </p>
		<p>
			<label for="<?php echo $this->get_field_id ('precontent'); ?>"><?php _e('Pre-Content', 'handy-feature-pack'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id ('postcontent'); ?>"><?php _e('Post-Content', 'handy-feature-pack'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'phone' ); ?>"><?php _e( 'Phone:', 'handy-feature-pack' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'fax' ); ?>"><?php _e( 'Fax:', 'handy-feature-pack' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'skype' ); ?>"><?php _e( 'Skype:', 'handy-feature-pack' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'email' ); ?>"><?php _e( 'Email:', 'handy-feature-pack' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'address' ); ?>"><?php _e( 'Address:', 'handy-feature-pack' ); ?></label>
