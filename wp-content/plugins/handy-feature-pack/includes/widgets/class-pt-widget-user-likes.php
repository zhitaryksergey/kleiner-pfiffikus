...
class pt_user_likes_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__('Handy User Likes', 'handy-feature-pack'),
			array( 'description' => __( 'Handy special widget. If the user is logged in, output a list of posts that the user likes', 'handy-feature-pack' ), )
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( is_user_logged_in() ) { // user is logged in
			...
			if ( $count > 0 ) {
				...
				$like_list .= "<h3>" . __( 'You Like:', 'handy-feature-pack' ) . "</h3>\n";
				$like_list .= "<ul>\n";
