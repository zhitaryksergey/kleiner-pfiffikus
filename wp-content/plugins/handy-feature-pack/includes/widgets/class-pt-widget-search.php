...
class pt_search_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__('Handy Search', 'handy-feature-pack'), // Name
			array('description' => __( "Handy special widget. A search form for your site.", 'handy-feature-pack' ), )
		);
	}
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Input Text: ', 'handy-feature-pack' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Button Title Text: ', 'handy-feature-pack' ) ?></label>
      ...
      <label for="<?php echo $this->get_field_id("category-search"); ?>"><?php _e( 'Add "search in category" dropdown?', 'handy-feature-pack' ); ?></label>
    </p>
		<p><?php _e('Select which categories to display','handy-feature-pack'); ?></p><p>
		<?php
		$typeoptions = array (
							"category" => __("Post categories",'handy-feature-pack'),
							"product_cat" => __("Product categories",'handy-feature-pack'),
		);
		...
		?></p>
		<p>
			<label for="<?php echo $this->get_field_id('exclude'); ?>"><?php _e( 'Exclude next categories(a comma-separated list of categories by unique ID, in ascending order): ', 'handy-feature-pack' ) ?></label>
	...
	<form class="pt-searchform" method="get" action="<?php echo esc_url( home_url() ); ?>">
		...
		<?php if ($category_search) {
			...
			if ($categories) {
				...
				$select_output .= '<option value="">'.__('All Categories', 'handy-feature-pack').'</option>';
