...
class WC_GZDP_PDF_Helper {
	...
	public function set_upload_dir_not_exist_notice() {
		...
		?>
			<div class="error">
				<p><?php printf( __( 'WooCommerce Germanized Pro upload directory doesn\'t seem to exist. Please create the folder %s and make sure that it is writeable.', 'woocommerce-germanized-pro' ), '<i>wp-content/uploads/' . $dirname . '</i>' ); ?></p>
			</div>
	...
	public function parse_custom_fonts() {
		...
		$files     = @glob( trailingslashit( $path ) .'*.ttf' );
		...
		$font_files = @glob( trailingslashit( $path ) .'*.php' );
	...
	public function get_layout_settings( $type = '' ) {
		...
		$layout_settings_templates = apply_filters( 'woocommerce_gzdp_' . $type . '_layout_settings_templates', array(
			...
			array(
				...
				'desc' 		=> _x( 'Show a default header.', 'pdf', 'woocommerce-germanized-pro' ) . '<div class="wc-gzd-additional-desc">' . sprintf( _x( 'You may override this template in your theme %s', 'pdf', 'woocommerce-germanized-pro' ), '<br/>[woocommerce-germanized-pro/' . str_replace( '_', '-', $type ) . '/header.php]' ) . '</div>',
			...
			array(
				...
				'desc' 		=> _x( 'Show a default footer.', 'pdf', 'woocommerce-germanized-pro' ) . '<div class="wc-gzd-additional-desc">' . sprintf( _x( 'You may override this template in your theme %s', 'pdf', 'woocommerce-germanized-pro' ), '<br/>[woocommerce-germanized-pro/' . str_replace( '_', '-', $type ) . '/footer.php]' ) . '</div>',
			...
			array(
				...
				'desc' 		=> _x( 'Show a custom first page header.', 'pdf', 'woocommerce-germanized-pro' ) . '<div class="wc-gzd-additional-desc">' . sprintf( _x( 'You may override this template in your theme %s', 'pdf', 'woocommerce-germanized-pro' ), '<br/>[woocommerce-germanized-pro/' . str_replace( '_', '-', $type ) . '/header-first.php]' ) . '</div>',
		...
		$layout_settings_page_numbers = apply_filters( 'woocommerce_gzdp_' . $type . '_layout_settings_page_numbers', array(
			...
			array(
				...
				'custom_attributes' => array(
					'data-show_if_woocommerce_gzdp_' . $type . '_show_page_numbers' => '',
                ),
				'type' 		=> 'text',
		...
		$layout_settings_title_end    = apply_filters( 'woocommerce_gzdp_' . $type . '_layout_settings_title_end', array(
			array( 'type' => 'sectionend', 'id' => $type . '_layout_options' ),
		) );
