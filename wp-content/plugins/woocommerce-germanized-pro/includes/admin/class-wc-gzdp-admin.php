...
class WC_GZDP_Admin {
	...
	public function __construct() {
		...
		add_action( 'woocommerce_gzd_deleted_cached_plugin_header_data', array( $this, 'delete_cached_plugin_header_data' ) );
	...
	public function delete_cached_plugin_header_data() {
        WC_GZDP_Dependencies::instance()->delete_cached_plugin_header_data();
    }
