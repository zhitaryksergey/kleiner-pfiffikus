...
class WC_GZDP_Settings_Tab_Revocation_Generator extends WC_GZDP_Settings_Tab_Generator {
	...
	public function get_description() {
		return __( 'Easily generate your custom revocation terms through our API.', 'woocommerce-germanized-pro' );
	}

	public function get_label() {
		return __( 'Revocation Terms Generator', 'woocommerce-germanized-pro' );
	}
