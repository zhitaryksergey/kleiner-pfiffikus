		...
		<div class="wc-gzd-shipment-packing-slip-content">
			<div class="shipment-packing-slip-actions">
				<div class="shipment-packing-slip-actions-wrapper shipment-packing-slip-create">
                    <a class="button button-secondary download-shipment-packing-slip" data-packing_slip="<?php echo esc_attr( $packing_slip->get_id() ); ?>" href="<?php echo $packing_slip->get_pdf_url();?>" target="_blank"><?php _e( 'Download', 'woocommerce-germanized-pro' ); ?></a>
